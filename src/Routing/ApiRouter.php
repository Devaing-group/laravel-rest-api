...
namespace Devaing\RestAPI\Routing;

use Closure;
use Devaing\RestAPI\Exceptions\ApiException;
use Devaing\RestAPI\Middleware\ApiMiddleware;
...
class ApiRouter extends Router
{
    ...
    {
        if ($this->container && $this->container->bound('Devaing\RestAPI\Routing\ApiResourceRegistrar')) {
            $registrar = $this->container->make('Devaing\RestAPI\Routing\ApiResourceRegistrar');
        }
        else {
...
//             $routes->add($route);
            ...
            // Options route
           // $route = $this->createRoute(['OPTIONS'], $uri, ['uses' => '\Devaing\RestAPI\Routing\ApiRouter@returnRoute']);
